...
pdf.cell(0,30,"CS50 Shirtificate", new_x="LMARGIN", new_y="NEXT", border = 1, align = 'C')

pdf.cell(0,100,"", new_x="LMARGIN", new_y="NEXT", border = 1, align = 'C')


img = Image.open("shirtificate.png")
img = img.crop((0, 0, 593, 592)).resize((493, 492))
pdf.image(img, x=20, y=90, keep_aspect_ratio=True)
#pdf.cell(0, 30, f"{name} took CS50", new_x="Center", new_y="NEXT", align='C', border = 1)
pdf.cell(0, 30, f"{name} took CS50", new_x="CENTER", new_y="NEXT", border = 1, align = 'C')
